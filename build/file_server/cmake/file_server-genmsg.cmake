...
get_filename_component(_filename "/home/will/catkin_ws/src/file_server/srv/GetBinaryFile.srv" NAME_WE)
add_custom_target(_file_server_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "file_server" "/home/will/catkin_ws/src/file_server/srv/GetBinaryFile.srv" ""
)
...
_generate_srv_cpp(file_server
  "/home/will/catkin_ws/src/file_server/srv/GetBinaryFile.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/file_server)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/file_server\")")
  # install generated code
  install(
